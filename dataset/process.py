...
parser.add_argument('--dataset', default='diginetica',
                    help='dataset name: diginetica/nowplaying/retailrocket/tmall/yoochoose')
...
if opt.dataset == 'diginetica':
    dataset = "D:/dataSet/dataset-train-diginetica/train-item-views.csv"
...
# train = train + test
tr_seqs = tr_seqs + va_seqs
tr_labs = tr_labs + va_labs
...
if opt.dataset == 'diginetica':
    ...
    pickle.dump(train, open('diginetica/train.pkl', 'wb'))
    pickle.dump(test, open('diginetica/test.pkl', 'wb'))
